-- 013: la cola del panel se limita a las últimas 24 horas.
--
-- `waiting` y `processing` contaban sin ventana temporal, así que cualquier
-- evento colgado inflaba la cola de forma permanente. La migración 012 añade el
-- reaper que los cierra; esto acota además el conteo al mismo periodo que
-- `failed_24h`, para que las tres cifras hablen del mismo intervalo.
